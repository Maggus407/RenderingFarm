...
from backend.turbo_settings import DEFAULT_TURBO_SETTINGS, get_turbo_settings, validate_turbo_settings
...
app = Flask(
    __name__,
    template_folder=str(context.BASE_DIR / "templates"),
    static_folder=str(context.BASE_DIR / "static"),
)
